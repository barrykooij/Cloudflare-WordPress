...
class ClientActions extends \Cloudflare\APO\WordPress\ClientActions {
    public function __construct(\Cloudflare\APO\Integration\DefaultIntegration $integrationContext, \Cloudflare\APO\API\APIInterface $api, \Cloudflare\APO\API\Request $request) {
